 ...
 */
final class Version20260418004534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_banned TINYINT DEFAULT 0 NOT NULL, ADD banned_at DATETIME DEFAULT NULL, ADD banned_until DATETIME DEFAULT NULL, ADD ban_reason VARCHAR(255) DEFAULT NULL, CHANGE dateofbirth dateofbirth VARCHAR(50) NOT NULL, CHANGE face_data face_data LONGTEXT DEFAULT NULL, CHANGE face_enabled face_enabled TINYINT DEFAULT 0 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP is_banned, DROP banned_at, DROP banned_until, DROP ban_reason, CHANGE dateofbirth dateofbirth VARCHAR(100) NOT NULL, CHANGE face_data face_data TEXT DEFAULT NULL, CHANGE face_enabled face_enabled TINYINT DEFAULT 0');
