 ...
 */
final class Version20260506223128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event_registrations ADD updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event_registrations DROP updated_at');
