 ...
 */
final class Version20260506192758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE login_attempts CHANGE was_successful was_successful TINYINT NOT NULL, CHANGE user_agent user_agent LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE sessions CHANGE session_id session_id INT AUTO_INCREMENT NOT NULL, CHANGE status status VARCHAR(20) DEFAULT \'scheduled\', CHANGE average_rating average_rating NUMERIC(3, 1) DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE user CHANGE dateofbirth dateofbirth DATE DEFAULT NULL, CHANGE face_data face_data LONGTEXT DEFAULT NULL, CHANGE face_enabled face_enabled TINYINT DEFAULT 0 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE goal ADD CONSTRAINT FK_FCDCEB2EA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE login_attempts CHANGE was_successful was_successful TINYINT DEFAULT 0 NOT NULL, CHANGE user_agent user_agent TEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE `user` CHANGE dateofbirth dateofbirth DATE NOT NULL, CHANGE face_data face_data TEXT DEFAULT NULL, CHANGE face_enabled face_enabled TINYINT DEFAULT 0');
